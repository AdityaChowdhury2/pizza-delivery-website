...
function initAdmin(socket) {
  ...
  onDelete.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      ...
      console.log(pizzaId); //     axios.delete('/api/menu/' + pizzaId ).then(res =>{
      //         console.log(res);
      //         notie.alert({
      //             type: 'success',
      //             text: 'Item Deleted',
...
onDelete.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizzaId = btn.dataset.pizza; // console.log(pizzaId);

    axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]('/api/menu/' + pizzaId).then(function (res) {
      console.log(res);
      location.reload();
      notie__WEBPACK_IMPORTED_MODULE_2___default.a.alert({
        type: 'success',
...
module.exports = __webpack_require__(/*! C:\Project\resources\scss\app.scss */"./resources/scss/app.scss");
